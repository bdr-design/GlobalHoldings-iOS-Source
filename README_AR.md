...
BUILD306 ينعّم حركة الطائرات والسفن والشاحنات وMobility والمنافسين بطبقة عرض مرتبطة بإطارات الشاشة، من دون نقل ملكية الوقت أو تقدم الرحلة من Simulation Core. يوحّد فتح قواعد الطاقة وفروع البنك والمراكز اللوجستية عبر الدليل العالمي ومسارات الإنشاء الذرية الحالية. تحفظ إيرادات الرحلات في تسوية يومية دائمة أثناء اليوم ثم تُرحّل مرة واحدة إلى الحساب الجاري للشركة عند الإقفال. الرواتب المدفوعة والمستحقة أصبحت مرتبطة بحوالات رسمية ومراجع دفترية، وشاشة التأسيس أصبحت عقدًا حديثًا مع الحفاظ على جميع روابطها. كما أُصلح توزيع الأقسام الثمانية في الشريط الجانبي على كامل الارتفاع. يبقى Save Schema `2.0.0` متوافقًا دون تغيير.

راجع `BUILD306_DEEP_FIXES_AR.md` لعقود السلامة والاختبارات.

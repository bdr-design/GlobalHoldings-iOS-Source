...
BUILD307 يعالج الحركة والسرعة وفتح المنشآت وملكية المسارات من جذورها، مع إبقاء `Simulation Core` نفسه وذرية شرائحه وحدود الساعة واليوم دون تعديل. أصبحت السرعات التشغيلية خمسًا: `30× / 60× / 120× / 300× / 600×`، ويتبع العرض لقطات الحالة بتدرج محدود السرعة لا يتجاوز `72px/s` عند المستوى الأعلى، من دون أن يكتب في زمن اللعبة أو تقدم الأصل. اللوجستيات والطاقة والبنك لا تُفتح إلا من موقع أصلي موثق في الدليل العالمي، وفرع البنك والمنشأة يُنشآن ذريًا. كذلك يملك كل أصل مسارًا مستقلًا، وتمنع طبقة المجال مشاركة معرف المسار أو هندسته، كما تمنع Mobility تراكب سيارتين على مسار شارع نشط واحد. تستمر إصلاحات BUILD306 المالية والرواتب وعقد التأسيس والشريط الجانبي، ويبقى Save Schema `2.0.0` متوافقًا دون تغيير.

راجع `BUILD307_ROOT_FIXES_AR.md` لعقود السلامة والاختبارات، و`BUILD306_DEEP_FIXES_AR.md` للإصلاحات المالية والواجهية السابقة.

...
BUILD308 يغلق جذور الحركة والمسارات والحفظ المتزامن. بقي `Simulation Core` وذرية شرائح الزمن وحدود الساعة واليوم بلا تعديل، بينما صار تحريك العلامات طبقة عرض محدودة بين `28–36px/s` وبحد أقصى `50ms` لكل خطوة مرئية؛ لذلك لا تقفز العلامة حتى عند `600×` ولا تكتب طبقة العرض في زمن اللعبة أو تقدم الأصل. صار `Route Core` المالك الوحيد للمسارات، مع عزل الشركة والنوع، ورفض المعرف والهندسة والممر القريب المكرر، وسقوف صريحة للمسارات والنقاط والكاش.
...
راجع `docs/BUILD308_ROOT_SAFETY_NO_AUTONOMY_AR.md` للعقود والحدود واختبارات القبول، و`BUILD307_ROOT_FIXES_AR.md` للتغييرات السابقة.

(()=>{
  ...
  function delivery(facts={}){return result('DeliveryPolicy',[
  ...
  function evaluate(name,facts){if(name==='procurement')return procurement(facts);if(name==='delivery')return delivery(facts);return result(name,[]);}
  const API=Object.freeze({VERSION,evaluate,procurement,delivery});globalThis.GH_POLICY_CORE=API;if(globalThis.window&&globalThis.window!==globalThis)globalThis.window.GH_POLICY_CORE=API;if(typeof module!=='undefined'&&module.exports)module.exports=API;
})();

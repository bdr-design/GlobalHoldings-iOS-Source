(()=>{
  ...
  const CAPITALS=Object.freeze([
    ...
    {id:'DOH',country:'قطر',city:'الدوحة',coords:[25.2854,51.5310]},
    ...
    {id:'BER',country:'ألمانيا',city:'برلين',coords:[52.5200,13.4050]},

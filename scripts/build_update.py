...
def main():
    ...
    manifest={'id':'gh-internal-2.9.1-build272-mobility-riyadh-hub-marker','name':'Global Holdings 2.9.1 — Mobility Riyadh Hub Marker & Cleanup','version':VERSION,'minGameVersion':'2.9.0','packageType':'full-web','installMode':'clean-snapshot-v1','channel':'stable','signaturePayloadVersion':2,'createdAt':datetime.now(timezone.utc).isoformat(),'releaseNotes':'BUILD272: تحليل 3 صور شاشة حقيقية من اللاعب كشف السبب الجذري الحقيقي لعدم ظهور Mobility على الخريطة - الرياض مركز افتراضي ضمني لا يمر بمسار فتح مركز عاصمة العادي، فلم تكن تُنشأ له أي منشأة حقيقية عند الإطلاق، فيظهر أسطوله كنقاط متحركة فقط دون أي علامة مقر ثابتة كما لكل شركة أخرى؛ الآن يُنشأ سجل منشأة حقيقي للرياض فور أول إطلاق فتظهر علامته على الخريطة فورًا. أصلح أيضًا: نص ذاتي التناقض في صفحة مركز الرياض (كان يصف نفسه بأنه منفصل عن نفسه)، إحصاء استغلال وهمي يعرض دائمًا 0% بدل حساب حقيقي من بيانات المركز، جدول عناوين ثالث منفصل في app.js كان لا يزال يحمل مفتاحي لوحتين محذوفتين فعليًا منذ BUILD270 (بقايا تنظيف سابق غير مكتمل اكتُشفت أثناء هذا التدقيق نفسه)، وأضاف تبويب Mobility في لوحة الأساطيل والأصول يوجّه صراحة لمكانها الحقيقي بدل تجاهلها بصمت. Save Schema يبقى 2.0.0.',
    ...
    for ext in ('saneiupdate','ghupdate'):
        (UPDATES/f'GlobalHoldings_Internal_Update_V291_BUILD272_MOBILITY_RIYADH_HUB_MARKER.{ext}').write_text(payload,encoding='utf-8')

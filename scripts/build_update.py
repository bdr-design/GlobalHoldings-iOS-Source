...
def main():
    ...
    manifest={'id':'gh-internal-2.9.1-build277-one-tap-onboarding','name':'Global Holdings 2.9.1 — One-Tap Company Onboarding','version':VERSION,'minGameVersion':'2.9.0','packageType':'full-web','installMode':'clean-snapshot-v1','channel':'stable','signaturePayloadVersion':2,'createdAt':datetime.now(timezone.utc).isoformat(),'releaseNotes':'BUILD277: السبب الجذري الحقيقي لشكويين متكررتين (لا تظهر Mobility على الخريطة + فتح القواعد معقّد) كان تصميميًا: تأسيس أي شركة من قائمة الشركات لا يضع شيئًا على الخريطة، والإجراء الأول الحقيقي (إطلاق الأسطول / فتح أول قاعدة) مدفون 4-5 مستويات. الآن: تأسيس Mobility ينشئ مركز الرياض على الخريطة فورًا وينقل العرض إليه، وكل بطاقة شركة مؤسَّسة تعرض زر خطوة تالية واحدًا يوصل مباشرة لأول إجراء (إطلاق الأسطول بضغطة واحدة، افتح أول قاعدة جوية/ميناء/مركز لوجستي). لوحة التشغيل خُفِّضت من 7 بطاقات إلى 5 بدمج حلقة وسيطة بلا فائدة (الشراء اليدوي يفتح السوق مباشرة) وإزالة مدخل ثالث مكرر للدليل العالمي (يبقى متاحًا من شريط الخريطة ومنشآت الشركة). شريط حالة الخريطة يعرض صراحة عدد سيارات Mobility والمنشآت المملوكة. حُذفت 3 بقايا أخرى من نظام طلبات الأصول المحذوف في BUILD260. Save Schema يبقى 2.0.0.',
    ...
    for ext in ('saneiupdate','ghupdate'):
        (UPDATES/f'GlobalHoldings_Internal_Update_V291_BUILD277_ONE_TAP_ONBOARDING.{ext}').write_text(payload,encoding='utf-8')

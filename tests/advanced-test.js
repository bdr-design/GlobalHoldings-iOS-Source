...
const panels=['leadershipHub','actionCenter','governanceHub','compliance','systemHub','aiApprovals','programs','diagnostics','companies','intelligence','treasury','audit','legal','procurement','cyber','safety','energy','bank','governance','insurance','research','esg','career','news','labor','ma','settings','updates'];

...
function scenario(){
 const h=harness(['transaction-core','domain-command-core','save-schema','determinism-core','event-ledger-core','dependency-core','policy-core','lifecycle-core','demand-closure-core','catalog','realism-core','finance-core','hr-core','corporate-core','procurement-core','facility-core','fleet-core','ai-executive-core','operations-core','route-core','game-lifecycle-core','market-core']);

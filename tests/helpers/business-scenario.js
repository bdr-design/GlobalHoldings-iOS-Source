...
function scenario(){
 const h=harness(['world-data','transaction-core','domain-command-core','save-schema','determinism-core','event-ledger-core','dependency-core','policy-core','lifecycle-core','delivery-monitor-core','catalog','realism-core','finance-core','hr-core','corporate-core','procurement-core','facility-core','fleet-core','operations-core','route-core','game-lifecycle-core','market-core','mobility-core']);

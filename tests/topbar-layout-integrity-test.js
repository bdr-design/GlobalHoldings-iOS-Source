...
for(const k of ['GH_REQUEST_CORE','GH_LIFECYCLE_CORE','GH_POLICY_CORE','GH_DEPENDENCY_CORE','GH_EVENT_LEDGER','GH_DEMAND_CLOSURE','GH_INTEGRITY_CORE'])global[k]={VERSION:'3.0.0',check(){return {issues:[]}},detectCycles(){return []},reconcile(){return {}},summary(){return {}}};

...
for(const k of ['GH_TRANSACTION_CORE','GH_SIMULATION_CORE','GH_SAVE_SCHEMA','GH_DETERMINISM'])global[k]={VERSION:'3.0.0',execute(){},create(){},normalize(){}};
for(const k of ['GH_REQUEST_CORE','GH_LIFECYCLE_CORE','GH_POLICY_CORE','GH_DEPENDENCY_CORE','GH_EVENT_LEDGER','GH_DELIVERY_MONITOR','GH_INTEGRITY_CORE'])global[k]={VERSION:'3.0.0',check(){return {issues:[]}},detectCycles(){return []},reconcile(){return {}},summary(){return {}}};

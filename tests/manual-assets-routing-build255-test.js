...
assert(advanced.includes("COMPANY_TAB_LABELS")&&advanced.includes("overview:'القيادة'")&&advanced.includes("assets:'الأصول'")&&advanced.includes("people:'الأفراد'")&&advanced.includes("finance:'المالية'")&&advanced.includes("risk:'المخاطر'")&&advanced.includes("ai:'AI الشركة'")&&advanced.includes("tabDefs.push(['ai',COMPANY_TAB_LABELS.ai])"),'all companies expose assets and people tabs, and the AI tab definition still exists (conditionally, per BUILD282)');

...
for(const token of [
  ...
  'WebApp.previous','WebApp.staging','clearPendingBootMarker','Overlay/Delete updates مرفوضة'
...
assert(builder.includes("'installMode':'clean-snapshot-v1'")&&builder.includes("'signaturePayloadVersion':3"),'Update builder is not emitting Build-bound signed clean snapshots');
console.log('Clean Atomic Update Installer 2.3.3: PASS');

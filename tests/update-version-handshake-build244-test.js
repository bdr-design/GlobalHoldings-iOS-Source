...
assert(app.includes("const APP_VERSION = '2.9.1';"),'runtime must report the internal update version for Native boot confirmation');
assert(adv.includes("const VERSION = '2.9.1';"),'web update gate must report the internal update version');
assert(builder.includes("VERSION='2.9.1'"),'signed package must target the internal update version');

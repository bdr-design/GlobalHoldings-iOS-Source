...
const panels=['leadershipHub','workspaceHub','peopleHub','actionCenter','companies','control','finance','governanceHub','systemHub','network','routes','globalRoute','market','more','contracts','ma','labor','assets','assetMarket','expansion','invoices','news','settings','diagnostics','competitors','assetManage','assignRoute','ports','energy','bank','governance','insurance','research','esg','career','realism','intelligence','aiApprovals','programs','facilityManage','companyManage','treasury','audit','legal','procurement','cyber','safety','updates'];

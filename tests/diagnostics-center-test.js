...
assert.strictEqual(d.VERSION,'3.0.0');
...
const bundle=d.exportBundle(state,{appVersion:'3.0.0',saveSchemaVersion:'2.0.0',simulation:{backlogSeconds:0}});
assert.strictEqual(bundle.format,'global-holdings-diagnostic-bundle');
assert.strictEqual(bundle.appVersion,'3.0.0');

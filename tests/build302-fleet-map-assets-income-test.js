...
assert(app.includes('minRealSliceSeconds:.5'));assert(app.includes('allowedSpeeds:[0,30,120,600]'));assert(app.includes('snapshot:simulationAssetSnapshot(asset)'));assert(!app.includes('profile:state.profile,crew:state.crew,advanced:state.advanced,realism:state.realism'));

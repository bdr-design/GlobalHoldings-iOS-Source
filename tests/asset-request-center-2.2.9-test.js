...
assert.strictEqual(core.VERSION,'2.9.1');
...
assert(advanced.includes("if(proposal.kind==='procurement'){continue;}"),'legacy hourly procurement proposals must not recreate the retired single-asset path');

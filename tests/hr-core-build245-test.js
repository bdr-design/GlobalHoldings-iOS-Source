...
const src=fs.readFileSync('WebApp/hr-core.js','utf8');const sb={console,structuredClone,globalThis:null};sb.globalThis=sb;sb.window=sb;vm.runInNewContext(src,sb);const hr=sb.GH_HR_CORE;assert(hr&&hr.VERSION==='3.0.0');

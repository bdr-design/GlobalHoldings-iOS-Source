...
assert(app.includes("'routes','cache-geometry'")&&/cachedAtSim:Math\.max\(0,Number\((?:s|state)\.simSeconds\)\|\|0\)/.test(fs.readFileSync("WebApp/route-core.js","utf8")),'route cache must use simulation timestamp');

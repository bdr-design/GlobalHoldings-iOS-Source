...
(async()=>{
 ...
 const adv=fs.readFileSync(path.join(root,'WebApp','advanced-core.js'),'utf8');assert(adv.includes('workflow-stepper ma-workflow'));assert(adv.includes('request-financial-summary'));
